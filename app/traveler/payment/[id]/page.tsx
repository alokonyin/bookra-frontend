    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-blue-600 text-white rounded-lg p-6 sticky top-6">
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-blue-100">{booking.trip?.date}</p>
              </div>
              ...
              <div className="bg-blue-700 rounded-lg p-3 mt-4">
